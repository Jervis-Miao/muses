...
public abstract class AbstractDateConverter extends AbstractSearchDataConverter {
    ...
    protected static Date truncate(Date date, int field) {
        if (date == null) {
