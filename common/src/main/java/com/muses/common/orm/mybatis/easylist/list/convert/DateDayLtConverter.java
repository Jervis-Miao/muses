 ...
 * Author lvchenggang
 * XYZ Reserved
 * Created on 2016年4月13日 下午5:06:06
 */
 ...
 *
 */
public class DateDayLtConverter extends DateLtConverter {
    ...
    protected Criterion buildCriteria(Criteria targetCriteria, SearchData data) {
        ...
        return targetCriteria.addLessThanCriterion(getByDialect(data.getColumn(), data.getDialect()), result);
    }
