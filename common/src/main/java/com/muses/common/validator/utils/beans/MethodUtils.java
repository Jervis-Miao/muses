package com.muses.common.validator.utils.beans;
...
public class MethodUtils {
    private static final Logger logger = LoggerFactory.getLogger(MethodUtils.class.getClass());
    ...
    public static Object invokeGetterMethod(final Object object, final Method method)
     ...
     */
    private static Method getGetterMethod(Class<?> clazz, String methodName)
