...
/**
 * 自动重读配置：IntelliJ下修改配置后需要按Ctrl+F9（Make Project） jdk1.7以后可以通过nio2的WatchService实现，这里使用jpatchwatch实现
 * <bean id="validatorConfReload" class="com.muses.common.validator.spring.EasyValidatorConfReload" />
 */
