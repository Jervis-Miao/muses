package cn.muses.common.orm.mybatis.easylist.paginator.domain;
...
public class Order implements Serializable {
     ...
     * @param property
     * @param direction
     * @param orderExpr placeholder is "?", in oracle like: "nlssort( ? ,'NLS_SORT=SCHINESE_PINYIN_M')". Warning: you
     *            must prevent orderExpr SQL injection.
     * @return
     */
