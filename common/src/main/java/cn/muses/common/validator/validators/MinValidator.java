...
/**
 * Check that the number being validated is greater than or equal to the minimum value specified. Check that the
 * character sequence (e.g. string) being validated represents a number, and has a value more than or equal to the
