...
public class AreaUtil {
    ...
    public static void main(String[] args) throws IOException {
		WebClient mWebClient = new WebClient(BrowserVersion.CHROME,"192.168.16.189",8080);
		//是否使用不安全的SSL
