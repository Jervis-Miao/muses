...
public class AdjustAllExamplePlugin extends PluginAdapter {
	...
	public void setProperties(Properties properties) {
		...
		if (StringUtils.isBlank(selfProperties.getProperty(TARGET_PROJECT_PROPERTY_NAME))) {
			...
			selfProperties.put(TARGET_PROJECT_PROPERTY_NAME, context.getJavaModelGeneratorConfiguration()
					.getTargetProject());
		}
		if (StringUtils.isBlank(selfProperties.getProperty(TARGET_PACKAGE_PROPERTY_NAME))) {
			...
			selfProperties.put(TARGET_PACKAGE_PROPERTY_NAME, context.getJavaModelGeneratorConfiguration()
					.getTargetPackage());
		}
	...
	public void initialized(IntrospectedTable introspectedTable) {
		...
		if (needReplace) {
			...
			// 替换Select
			introspectedTable.setSelectByExampleStatementId(replaceString(introspectedTable
					.getSelectByExampleStatementId()));
			introspectedTable.setSelectByExampleWithBLOBsStatementId(replaceString(introspectedTable
					.getSelectByExampleWithBLOBsStatementId()));
			// 替换Count
			introspectedTable.setCountByExampleStatementId(replaceString(introspectedTable
					.getCountByExampleStatementId()));
			// 替换Update
			introspectedTable.setUpdateByExampleSelectiveStatementId(replaceString(introspectedTable
					.getUpdateByExampleSelectiveStatementId()));
			introspectedTable.setUpdateByExampleStatementId(replaceString(introspectedTable
					.getUpdateByExampleStatementId()));
			introspectedTable.setUpdateByExampleWithBLOBsStatementId(replaceString(introspectedTable
					.getUpdateByExampleWithBLOBsStatementId()));
			// 替换Delete
			introspectedTable.setDeleteByExampleStatementId(replaceString(introspectedTable
